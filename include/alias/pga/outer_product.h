#ifndef _ALIAS_PGA_OUTER_PRODUCT_H_
#define _ALIAS_PGA_OUTER_PRODUCT_H_

#include <alias/pga/real.h>
#include <alias/pga/binary.h>

#define ALIAS_PGA_BINARY_OUTER_PRODUCT(RETURN, A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P, a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p, ...) ALIAS_PGA_BINARY_OUTER_PRODUCT_(RETURN, A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P, a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p, ALIAS_PGA_RZ_ADD_MUL,ALIAS_PGA_RZ_SUBTRACT_MUL,## __VA_ARGS__)
#define ALIAS_PGA_BINARY_OUTER_PRODUCT_(RETURN, One,E0,E1,E2,E3,E01,E02,E03,E12,E31,E23,E021,E013,E032,E123,E0123, one,e0,e1,e2,e3,e01,e02,e03,e12,e31,e23,e021,e013,e032,e123,e0123, P,M, ...) \
  RETURN( \
    0 P(One, one) \
  , 0 P(One, e0)    P(E0, one) \
  , 0 P(One, e1)                P(E1, one) \
